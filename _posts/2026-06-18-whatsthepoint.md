...
<strong>What's the Point? Spatial Grammar &amp; Index Resolution for Sign Language Recognition</strong> is available on arXiv.

<br><br>

<strong>Venue:</strong> arXiv preprint<br>
<strong>Authors:</strong> Ranum, O., Hadfield, S., Bowden, R.

</td>
</tr>
</table>

[🌐 Project Page](https://olineranum.github.io/WhatsThePoint/content.html){:target="_blank"} &nbsp;·&nbsp; [📄 arXiv](https://arxiv.org/pdf/2606.08056){:target="_blank"}
